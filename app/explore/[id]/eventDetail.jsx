                ...
                <div className="bg-zinc-800 p-4 text-zinc-200 rounded-lg">
                  ...
                  <div className="py-2 flex">
                    ...
                    <div className=" flex flex-col">
                      <p className=" text-lg font-bold  break-words">{event?.dates?.start?.localTime}</p>
                  ...
                  <div className="py-2 flex">
                    ...
                    <div>
                      <p className=" text-lg font-bold break-words">{event?._embedded.venues[0].name}</p>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div>
                    <div className="event-description break-words">
                      {event?.accessibility?.info ? (
                        <div dangerouslySetInnerHTML={{ __html: event?.accessibility?.info }} />
                      ) : (
                        <p>No Information</p>
                      )}
                    </div>
                ...
                <div className="flex-row gap-4 w-full">
                  {/* <div className="mt-4 w-full xl:w-[50%] p-4 rounded-lg bg-zinc-800">
                                    ...
                                    <div className="my-2 pl-2 flex items-center">
                                        <p className="text-lg w-full font-semibold break-words">{event?.organizer}</p>
                                    </div>
                                    <div className="my-2 pl-2 flex items-center">
                                        <p className="text-lg w-full font-semibold break-words">Price : {event?.priceRanges[0].min}</p>
                                    </div>
                                </div> */}
                  <div className="mt-4 w-full xl:w-[50%] p-4 rounded-lg bg-zinc-800">
                    <div className="my-2 pl-2 border-l-4 border-green-400 flex items-center">
                    ...
                    {event?.priceRanges[0].min ? (
                      <div className="my-2 pl-2 flex items-center">
                        <p className="text-lg w-full font-semibold break-words">{event?.priceRanges[0].min} {event.priceRanges[0].currency} </p>
                      </div>
                    ) : (<p>No price</p>)}
                  ...
                  <div className="mt-4 w-full xl:w-[50%] p-4 rounded-lg bg-zinc-800">
                    <div className="my-2 pl-2 border-l-4 border-green-400 flex items-center">
                      <p className="text-lg font-bold text-zinc-300">Adress</p>
                    </div>
                    <div className="w-full h-[2px] bg-slate-500 mb-4"></div>
                    <div className="my-2 pl-2 flex items-center">
                      <div className="pl-2 break-words">
                        <p className="text-lg w-full font-semibold break-words"> {event?._embedded.venues[0].address.line1} {event?._embedded.venues[0].city.name} {event?._embedded.venues[0].country.name}</p>
                      </div>
                    </div>
                  </div>
                  <div className="mt-4 w-full xl:w-[50%] p-4 rounded-lg bg-zinc-800">
                    <div className="my-2 pl-2 border-l-4 border-green-400 flex items-center">
                      <p className="text-lg font-bold text-zinc-300 cursor-pointer">Ticket Reservation</p>
                    </div>
                    <div className="w-full h-[2px] bg-slate-500 mb-4"></div>
                    <Link href={event?.url}>
                      <div className="my-2 pl-2 flex items-center">
                        <div className="pl-2 break-words">
                          <p className="text-lg w-full font-semibold break-words">{event?.url}</p>
                        </div>
                      </div>
                    </Link>
                  </div>

          ...
          <div className="flex flex-row gap-4 lg:flex-row justify-center items-start">
            <div className="flex flex-col w-full max-w-[800px] mx-auto lg:mx-0 gap-4 lg:w-[60%]">
              <div className="w-full h-[500px] relative rounded-lg overflow-hidden">
                <Image src={event?.images[0].url} fill={true} alt="" />
              </div>
              <div className="bg-zinc-800 p-4 text-zinc-200 rounded-lg">
                <div className="flex"></div>
                <div className="py-2">
                  <h2
                    className="z-20 mt-4 text-3xl font-extrabold duration-1000 lg:text-5xl text-zinc-200  group-hover:text-white font-display"
                  >
                    {event?.name}
                  </h2>
                </div>
                <div className="py-2 flex">
                  <div
                    className=" w-12 h-12 rounded-xl border border-solid border-slate-500 mr-3 flex justify-center items-center"
                  >
